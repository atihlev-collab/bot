...
def main_loop():
    ...
    while True:
        ...
        try:
            ...
            # PREMATCH + BET BUILDER are deliberately executed FIRST so a long
            # statistical scan can never hide/delay the football signals.
            if minutes >= 600 and last_day_football != day:
                ...
                # Statistical daily scanner is independent. A quota/error here
                # must not prevent PREMATCH/Builder, and it is attempted at most once.
                try:
                    ...
                    # Never retry the football morning flow during the same BG day.
