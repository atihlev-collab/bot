...
def main_loop():
    ...
    while True:
        ...
        try:
            ...
            # Live polling: every 5 minutes. get_live_matches() returns only
            # currently live fixtures, so outside match activity this remains a
            # single cheap schedule check. Live odds themselves are cached for
            # Highlightly's ~10-minute odds refresh interval.
