...
import requestsimport sqlite3import asyncioimport threadingimport timeimport logging



from scipy.stats import poissonfrom datetime import datetime, timedeltafrom zoneinfo import ZoneInfo
...
def analyze_live_match(fixture):try:fixture_id = fixture["fixture"]["id"]
...
🗓 Date: {match_date}🕒 Kickoff: {kickoff_time}
...
⭐ Rating Class:{"ELITE" if probability >= 95 else "STRONG"}

🏅 Model Rank:TOP 5 PICK

📋 Filter:TOP5 MODEL PICK
...
📊 Score:{match["goals"]["home"] or 0} - {match["goals"]["away"] or 0}

⏱ Minute: {minute}

{signal[0]}

🔥 Home Pressure: {home_pressure}🔥 Away Pressure: {away_pressure}

🎯 Shots On Target:{home_shots} - {away_shots}
