...
def get_best_live_signal(match):
    # LIVE ONLY FIX: use the existing Main 4 live-market engine.
    # This keeps real Betano live odds and the existing corners/cards/goals
    # market logic instead of the later V7 NEXT-GOAL-only override.
    try:
        candidates = build_live_market_candidates(match)
        if not candidates:
            return None
        ...
        logging.warning('LIVE MAIN4 ENGINE ERROR: %s', repr(e))
        return None
