            ...
            if response.status_code == 200:
                ...
                if isinstance(payload, dict):
                    ...
                    if original_endpoint == "fixtures":
                        ...
                        # Highlightly has no live=all filter.
                        # Filter today's matches locally by the documented live states.
                        if live_requested:
                            converted = [
                    ...
                    # Odds: normalize Highlightly's {matchId, odds:[...]}
                    # into the legacy {bookmakers:[{bets:[...]}]} shape
                    # already consumed by the bot's market parsers.
