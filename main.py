...
# GLOBAL COUNTRY EXCLUSION — applies to PREMATCH and LIVE before analysis.
BLOCKED_COUNTRIES_GLOBAL = {"russia", "belarus"}

def is_globally_blocked_country(value):
    if isinstance(value, dict):
        value = value.get("name") or value.get("countryName") or ""
    return clean_text(value).casefold() in BLOCKED_COUNTRIES_GLOBAL
    ...
    try:
        ...
        for match in matches:
            ...
            try:
                ...
                if country in BAD_COUNTRIES or is_globally_blocked_country(country):
                    continue
...
def main_loop():
    ...
    while True:
        ...
        live_window = 17 <= local_now.hour < 24
