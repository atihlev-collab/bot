...
def analyze_prematch_match(match):
    ...
    try:
        ...
        if (
            ...
            home_score >= 82
            and
            away_form["clean_sheet_pct"] <= 37          
            and
            home_odds_ok
            and
            home_form["unbeaten_pct"] >= 78
            and
            home_form["wins"] >= 4 
            and                         
            home_form["losses"] <= 1     
