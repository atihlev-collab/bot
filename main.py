...
print("HIGHLIGHTLY FOOTBALL BASE URL:", BASE_URL)
print("HIGHLIGHTLY FOOTBALL API: /matches")
...
if endpoint == "fixtures":
    ...
    elif endpoint in ("football/matches", "matches"):
    ...
    for attempt in range(1, API_RETRIES + 1):
        try:
            ...
            if response.status_code == 200:
                ...
                # Last five games
                if original_endpoint == "fixtures" and endpoint == "last-five-games":
                ...
                # Matches
                if original_endpoint in ("fixtures", "football/matches", "matches"):
                    rows = data if isinstance(data, list) else []
                    converted = []
...
def get_statistics(fixture_id):
    ...
    logging.info(
        "FOOTBALL API STATISTICS REQUEST | endpoint=/statistics/%s | fixture=%s",
        fixture_id,
        fixture_id
    )
