    ...
    while True:
        ...
        try:
            ...
            if minutes >= 600 and last_day_football != day:
                ...
                # Football statistical scanner is separate. Its quota/error
                # must never cancel PREMATCH/Builder, which already ran above.
                try:
            ...
            # ============================================================
            # 3) SPORT DAILY — once at/after 10:00 BG
            # ============================================================
            # Run after football PREMATCH/Builder and LIVE. This preserves
            # the existing Sport scanner and its daily quota protection.
