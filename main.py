...
# =========================================================
# PRACTICAL LIVE AI SYSTEM
# SMART RESET + PREMATCH AI VERSION (FULLY COMPLETED)
# =========================================================
...
def send_telegram(message):
    try:
        # Използваме asyncio, тъй като новата версия на ботовете изисква асинхронно изпращане
        ...
        try:
            ...
            for m in matches:
                try:
                    ...
                    # Финално завършване на твоята Prematch проверка
                    if confidence >= 75:
                        msg = f"""
...
"""
            ...
            pass
        await asyncio.sleep(1800) # Проверява за Prematch веднъж на 30 минути
...
async def main():
    ...
    # Стартираме двата цикъла (за LIVE и за PREMATCH) едновременно
